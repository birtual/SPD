...
<div id="container">
    ...
    <html:hidden property="ACTIONTODO" value="SELECCIONAR"/>
    <html:hidden property="idProceso" />
    <html:hidden property="idProcesoComparacion" />
	...
	<logic:notEmpty name="formulari" property="errors">
		...
		<table class="blueTable" border="1">
			<tr>
		 	...
		 	<logic:iterate id="data" name="formulari" property="listaProcesosCargados" type="lopicost.spd.struts.bean.FicheroResiBean" indexId="position">
				<tr>
					<td class="a150"><a href="javascript:compararProduccionOk('<bean:write name="formulari" property="idProceso" />',  '<bean:write name="data" property="idProceso" />');"><bean:write name="data" property="idProceso" /></a> <br></td>
					...
					<td class="a150"><bean:write name="data" property="idProceso" /></td>
