...
<%
	String resiCIP = (String) org.apache.commons.beanutils.PropertyUtils.getProperty(data, "resiCIP");
	String maskedCIP = (resiCIP != null && resiCIP.length() > 13) ? resiCIP.substring(0, 5) + "********" +resiCIP.substring(13, 14): resiCIP;
%>

    <td><bean:write name="data" property="resiCIP" /> - <%= maskedCIP %></td>
