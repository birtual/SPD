...
<body id="general">
		<center>
		<h2>Creación sustitución lite a partir de una existente </h2>
...
<bean:define id="data" name="formulari" property="sustitucionLite" />
     ...
     <html:hidden property="parameter" value="duplicar"/>
     <html:hidden property="ACTIONTODO" value="DUPLICAR"/>
...
<table>
	...
	<tr>
		<td>Nombre Corto</td>
		<td><html:text name="data" property="spdNombreBolsa" styleId="spdNombreBolsa" /></td>
	</tr>
