	...
	<logic:notEmpty  name="data" property="ttosEmblistados">
		<table border="1" style="width:100%">
	    	<thead>
				...
				<th>Medicamento bIRTUAL</th> <th>nombreMedicamentoBolsa</th> 
				
				
				<th>nomGtVmp</th>
				<th>ROBOT</th>
				<th>cantidadEmblistadaSPD</th>
				<th>Medicamento ROBOT</th> <th>nombreMedicamentoBolsa</th>
	       ...
	       <tr class="rd_cabecera">
				...
				<td><bean:write name="birtual" property="cn" /> - <bean:write name="birtual" property="nombreConsejoCnFinal" /></td>
				<td><bean:write name="birtual" property="nombreMedicamentoBolsa" /></td>
				<td><bean:write name="birtual" property="nomGtVmp" /></td>
				<th>ROBOT</th>
				<td><bean:write name="trat" property="cantidadTotalEmblistadaSPD" /></td>
				<td><bean:write name="robot" property="cn" /> - <bean:write name="robot" property="nombreConsejoCn" /></td>
