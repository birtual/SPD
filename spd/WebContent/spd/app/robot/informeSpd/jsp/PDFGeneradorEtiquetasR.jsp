  ...
  <logic:iterate id="trat" name="data" property="ttosEmblistados" type="lopicost.spd.robot.bean.rd.TratamientoPaciente">
    ...
    <logic:notEmpty name="trat" property="medicamentoReceta">
      ...
      <tr class="rd_cabecera">
		<td><bean:write name="receta" property="cn" /> - <bean:write name="receta" property="nombreMedicamentoConsejo" /></td>
        <td><bean:write name="medic" property="pautaResidencia" /></td>
        <td style="text-align: center;"><bean:write name="receta" property="lote" /></td>
        <td style="text-align: center;"><bean:write name="receta" property="caducidad" /></td>
