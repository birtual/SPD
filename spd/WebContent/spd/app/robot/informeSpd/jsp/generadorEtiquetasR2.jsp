...
<fieldset>
	...
	<logic:notEmpty  name="data" property="ttosEmblistados">
		<table border="1" style="width:60%">
	        ...
	        <tbody>
	       	<logic:iterate id="trat" name="data" property="ttosEm<tbody>
    ...
    <tr class="rd_cabecera">
      <c:choose>
        <c:when test="${not empty receta}">
          ...
          <c:choose>
            <!-- Mostrar en azul solo si los CN son distintos -->
            <c:when test="${medic.cn ne receta.cn}">
              <td style="color: blue;">
            </c:when>
            <c:otherwise>
              <td>
        ...
        <c:otherwise>
          ...
          <td><bean:write name="identRobot" property="resumen" /></td>
...
</tbody>blistados" type="lopicost.spd.robot.bean.rd.TratamientoPaciente">
			<bean:define id="medic" name="trat" property="medicamentoPaciente" />
			<bean:define id="identRobot" name="medic" property="identificacion" />
			...
			<logic:notEmpty name="trat" property="medicamentoReceta"> 
					...
					<td style="color: blue;"><bean:write name="receta" property="cn" /> - <bean:write name="receta" property="nombreMedicamentoConsejo" /></td>
					<td><bean:write name="medic" property="pautaResidencia" /></td>
					<td><bean:write name="receta" property="lote" /></td>
					<td><bean:write name="receta" property="caducidad" /></td>
					<td><bean:write name="receta" property="numeroSerie" /></td>
			...
			<logic:notEmpty name="receta" property="identificacion">
						<bean:define id="identReceta" name="receta" property="identificacion" />
					<td> <bean:write name="identReceta" property="resumen" /></td>	
