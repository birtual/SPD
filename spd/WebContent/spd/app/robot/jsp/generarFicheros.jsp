...
<fieldset>
   ...
   <input type="button" id="generateButton_<%=oidFicheroResiCabecera%>" class="negro" value="Confirmar" onclick="javascript:generarFicherosRobot('<%= oidFicheroResiCabecera %>')" />
