...
<script type="text/javascript">	
		...
		function editar(oidSustXComposicion) {
			  ...
			  console.log('La función editar() se está ejecutando');
			  ...
			  nuevaVentana.onbeforeunload = function() {
		   	  nuevaVentana.opener.retorno('valor de retorno'); // Llamar a la función retorno() con un valor de retorno
		  }
			// Añadir el siguiente código para asegurarse de que la ventana emergente siempre esté visible encima de la ventana principal en Chrome:
