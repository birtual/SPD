...
<table>
		<tr>
		  ...
		  <td>
		    <c:if test="${not empty SustXComposicionForm.listaGtVm}">
		      <html:select property="filtroCodGtVm" onchange="this.form.submit()">
		...
		<tr>
		  ...
		  <td>
		    <c:if test="${not empty SustXComposicionForm.listaGtVmpp}">
		      <html:select property="filtroCodGtVmpp" onchange="this.form.submit()">
		        <html:option value="">Todos</html:option>
