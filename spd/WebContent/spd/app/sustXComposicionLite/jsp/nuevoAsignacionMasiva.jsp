...
<div id="contingut">
     <html:hidden property="parameter" value="nuevoAsignacionMasiva"/>
     <html:hidden property="ACTIONTODO" value="NUEVO_MASIVA"/>
 	 <html:hidden property="filtroCodiLaboratorio"/>
     <html:hidden property="filtroCodGtVm"/>
...
<tr>
	<th>
	Asignar la Rentabilidad: <html:text name="SustXComposicionForm" property="rentabilidad" styleClass="rentabilidad" /><br>
	Ponderacion:<html:text name="SustXComposicionForm" property="ponderacion" styleClass="ponderacion" /><br>
	al laboratorio <html:text name="SustXComposicionForm" property="filtroCodiLaboratorio" styleClass="filtroCodiLaboratorio" /> -
	 <html:text name="SustXComposicionForm" property="nombreLab" styleClass="nombreLab" />
	</th>
</tr>
</table>
<table border="1">
