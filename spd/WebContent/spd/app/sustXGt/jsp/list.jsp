...
<logic:iterate id="hijo" name="padre" property="hijos" type="lopicost.spd.model.SustXGtvmpp" indexId="position2">
    <tr 
        id="hijo-${position}-${position2}" 
        class="${!empty hijo.nomLaboratorio ? 'hijo-con-laboratorio' : 'hijo'}" 
       
    >

<tr 
    id="hijo-${position}-${position2}" 
    class="${!empty hijo.nomLaboratorio ? (!empty hijo.nombreRobot ? 'hijo-laboratorio-farmacia' : 'hijo-laboratorio') : 'hijo'}"
>
