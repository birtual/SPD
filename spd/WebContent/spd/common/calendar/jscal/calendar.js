...
bottomBackground = "#f9f9f9";         // BG COLOR OF THE BOTTOM FRAME
tableBGColor     = "white";         // BG COLOR OF THE BOTTOM FRAME'S TABLE
cellColor        = "#eeeeee";     // TABLE CELL BG COLOR OF THE DATE CELLS IN THE BOTTOM FRAME
headingCellColor = "#888888";         // TABLE CELL BG COLOR OF THE WEEKDAY ABBREVIATIONS
...
hoverColor       = "black";       // TEXT COLOR OF A LINK WHEN YOU HOVER OVER IT
fontStyle        = "10pt verdana, helvetica";           // TEXT STYLE FOR DATES
headingFontStyle = "bold 10pt verdana, helvetica";      // TEXT STYLE FOR WEEKDAY ABBREVIATIONS
...
function createWeekdayList() {
    ...
    // IF FRENCH
    if (selectedLanguage == "fr") {
        weekdayList  = new Array('Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi', 'Dimanche');
        weekdayArray = new Array('Lu', 'Ma', 'Me', 'Je', 'Ve', 'Sa', 'Di');
    }
    // IF GERMAN
    else if (selectedLanguage == "de") {
        weekdayList  = new Array('Montag', 'Dienstag', 'Mittwoch', 'Donnerstag', 'Freitag', 'Samstag', 'Sonntag');
        weekdayArray = new Array( 'Mo', 'Di', 'Mi', 'Do', 'Fr', 'Sa','So');
    }
    // IF SPANISH
    else if (selectedLanguage == "es") {
        weekdayList  = new Array('Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado', 'Domingo')
    ...
    // IF CATALAN
        ...
        weekdayList  = new Array('Dilluns', 'Dimarts', 'Dimecres', 'Dijous', 'Divendres', 'Dissabte', 'Diumenge');
        weekdayArray = new Array('Dil','Dim','Dix','Dij','Div','Dis','Diu');
    }
    // DEFAULT TO SPANISH
    else {
        weekdayList  = new Array('Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado', 'Domingo')
