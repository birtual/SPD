...
var clicks=0;  //para impedir que se ejecute dos cllicks en el proceso
...
%>
	<html:form action="/Iospd/ImportFile.do" method="POST" enctype="multipart/form-data">
     	...
     	<html:hidden property="idUsuario"/>
   		<html:hidden property="cargaExtra" value="false"/>
	...
	<div id="container">
		...
		<logic:notEmpty property="lstDivisionResidencias" name="ImportIOSpdForm">
			...
			<logic:notEqual name="ImportIOSpdForm" property="idProcessIospd" value="">
				<logic:notEqual name="ImportIOSpdForm" property="idProcessIospd" value="importPlantillaXLS">
					<html:text name="ImportIOSpdForm" property="idProcessIospd" />
				</logic:notEqual>
						    
				<logic:equal name="ImportIOSpdForm" property="idProcessIospd" value="importPlantillaXLS">
					<html:text name="ImportIOSpdForm" property="idProcessIospd" value="importPlantillaXLS" />
				</logic:equal>
		...
		<logic:notEqual name="ImportIOSpdForm" property="operation" value="THREADING">
		 <p class="botons">
			<input type="button" class=".azulCielo" value="Procesar" onclick="javascript:generateExcel();" align="right">
