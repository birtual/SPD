...
public class InformeProdSpdDAO
{
    ...
    public static List<ProduccionPaciente> findByIdResidenciaCarga(String spdUsuario, FicheroResiBean cab) throws Exception {
        ...
        String qry = " SELECT distinct d.*, r.* ";
        qry += " FROM SPD_XML_detallesTomasRobot d ";
        qry += " LEFT JOIN SPD_robotProducciones r on d.idFreeInformation = r.FreeInformation    and d.CodGtVmp=r.CodGtVmp ";
        qry += " WHERE 1 = 1 ";
        qry += " and (d.idProceso ='"+ cab.getIdProceso() +"') ";
         qry += " ORDER BY  d.CIP, d.fechaToma,  d.idToma, d.dispensar ";


        
        Connection con = Conexion.conectar();
        System.out.println(String.valueOf(InformeProdSpdDAO.className) + "--> findByIdResidenciaCarga  -->" + qry);
        ResultSet rs = null;
