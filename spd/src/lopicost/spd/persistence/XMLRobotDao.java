...
//           List<String> contenidoTomas = new ArrayList<>();
	...
	public static List<DetallesTomasBean> getDetalleTomasRobot(String idUsuario, FicheroResiBean cab, TomasOrdenadas tomasGlobal, PacienteBean pac)throws Exception {
        ...
        try {
            ...
            // Construir la consulta dinúmica
	...
	*/
	...
	private static int getNumeroBolsas(String iDbolsaFechaDispTramo, String valorToma, String dispensar) {
		...
		if(dispensar!=null && dispensar.equals("N"))
		{
			...
			//comprimidos hasta ahora (se redondea al entero más práximo porque media pastilla cuenta como una)
	...
	private static DetallesTomasBean creaBeanPaso1DetallesTomas(String idUsuario, FicheroResiBean cabeceraTop, FicheroResiBean cab, ResultSet rs, List<Integer> posiciones, List<String> nombresTomas) throws Exception {
    	...
    	{ //ARREGLAR!!
       	 // Llenar las tomas dinúmicas y de paso la pauta de residencia
