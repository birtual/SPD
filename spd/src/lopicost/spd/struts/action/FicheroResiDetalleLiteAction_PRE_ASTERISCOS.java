...
public class FicheroResiDetalleLiteAction_PRE_ASTERISCOS extends GenericAction  {
	...
	public ActionForward refrescar(ActionMapping mapping, ActionForm form,
		...
		if(formulari.getACTIONTODO()!=null && formulari.getACTIONTODO().equals("REFRESCAR"))
		{
			...
			//para registros que no se han creado automáticamente, sino podráan volver a actualizarse de inicio, lo que supondría incoherencias 
