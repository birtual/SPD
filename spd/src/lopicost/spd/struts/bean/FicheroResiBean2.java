...
public class FicheroResiBean2 implements Serializable, Cloneable  {
	  ...
	  private String errores;
		...
		private int porcentajeCIPS;
		  ...
		  public FicheroResiBean2 clone() {
		        try {
		            return (FicheroResiBean2) super.clone();
		  ...
		  //importante para limpiar el texto, sin espacios, ni acentos, ni caracteres extraños y en UPPER
			...
			/**
			 * añadimos tambión el valor al campo detalleRowKeyLiteFechas
