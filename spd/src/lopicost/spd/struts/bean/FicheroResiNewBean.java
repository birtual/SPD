...
public class FicheroResiNewBean {
...
*/
	...
	public int getCipsTotalesProceso() {
		return cipsTotalesProceso;
	}


	public void setCipsTotalesProceso(int cipsFicheroOrigen) {
		this.cipsTotalesProceso = cipsFicheroOrigen;
	}
	...
	public int getCipsNoExistentesBbdd() {
		return cipsNoExistentesBbdd;
	}


	public void setCipsNoExistentesBbdd(int cipsNoExistentesBbdd) {
		this.cipsNoExistentesBbdd = cipsNoExistentesBbdd;
	}


	public int getCipsSpdResiNoExistentesEnProceso() {
		return cipsSpdResiNoExistentesEnProceso;
	}


	public void setCipsSpdResiNoExistentesEnProceso(int cipsSpdResiNoExistentesEnFichero) {
		this.cipsSpdResiNoExistentesEnProceso = cipsSpdResiNoExistentesEnFichero;
	}
	...
	public int getCipsFicheroOrigen() {
		return cipsFicheroOrigen;
	}


	public void setCipsFicheroOrigen(int cipsFicheroOrigen) {
		this.cipsFicheroOrigen = cipsFicheroOrigen;
	}
	...
	public String getSpdCodGtVm() {
		return spdCodGtVm;
	}


	public void setSpdCodGtVm(String spdCodGtVm) {
		this.spdCodGtVm = spdCodGtVm;
	}


	public String getSpdCodGtVmp() {
		return spdCodGtVmp;
	}


	public void setSpdCodGtVmp(String spdCodGtVmp) {
		this.spdCodGtVmp = spdCodGtVmp;
	}


	public String getSpdCodGtVmpp() {
		return spdCodGtVmpp;
	}


	public void setSpdCodGtVmpp(String spdCodGtVmpp) {
		this.spdCodGtVmpp = spdCodGtVmpp;
	}


	public String getSpdNomGtVm() {
		return spdNomGtVm;
	}


	public void setSpdNomGtVm(String spdNomGtVm) {
		this.spdNomGtVm = spdNomGtVm;
	}
	...
	public String getSpdEmblistable() {
		return spdEmblistable;
	}


	public void setSpdEmblistable(String spdEmblistable) {
		this.spdEmblistable = spdEmblistable;
	}


	public float getComprimidosDia() {
		return comprimidosDia;
	}


	public void setComprimidosDia(float comprimidosDia) {
		this.comprimidosDia = comprimidosDia;
	}


	public float getComprimidosSemana() {
		return comprimidosSemana;
	}


	public void setComprimidosSemana(float comprimidosSemana) {
		this.comprimidosSemana = comprimidosSemana;
	}


	public float getComprimidosDosSemanas() {
		return comprimidosDosSemanas;
	}


	public void setComprimidosDosSemanas(float comprimidosDosSemanas) {
		this.comprimidosDosSemanas = comprimidosDosSemanas;
	}


	public float getComprimidosTresSemanas() {
		return comprimidosTresSemanas;
	}


	public void setComprimidosTresSemanas(float comprimidosTresSemanas) {
		this.comprimidosTresSemanas = comprimidosTresSemanas;
	}


	public float getComprimidosCuatroSemanas() {
		return comprimidosCuatroSemanas;
	}


	public void setComprimidosCuatroSemanas(float comprimidosCuatroSemanas) {
		this.comprimidosCuatroSemanas = comprimidosCuatroSemanas;
	}


    public int getDiasConToma() {
        return this.diasConToma;
    }
    
    public void setDiasConToma(final int diasConToma) {
        this.diasConToma = diasConToma;
    }
    
    public String getResiPlanta() {
        return this.resiPlanta;
    }
    
    public void setResiPlanta(final String resiPlanta) {
        this.resiPlanta = resiPlanta;
    }
    
    public String getResiHabitacion() {
        return this.resiHabitacion;
    }
    
    public void setResiHabitacion(final String resiHabitacion) {
        this.resiHabitacion = resiHabitacion;
    }
	...
	public void setResiFrecuencia(int resiFrecuencia) {
		this.resiFrecuencia = resiFrecuencia;
	}
	...
	public int getFechaInicioInt() {
		return fechaInicioInt;
	}




	public void setFechaInicioInt(int fechaInicioInt) {
		this.fechaInicioInt = fechaInicioInt;
	}




	public int getFechaFinInt() {
		return fechaFinInt;
	}
	...
	public void setFechaFinInt(int fechaFinInt) {
		this.fechaFinInt = fechaFinInt;
	}




	public int getNumeroDeTomas() {
	...
	public void setNumeroDeTomas(int numeroDeTomas) {
	...
	public String getResiApellidos() {
		return resiApellidos;
	}




	public void setResiApellidos(String resiApellidos) {
		this.resiApellidos = resiApellidos;
	}




	public String getResiApellido1() {
		return resiApellido1;
	}




	public void setResiApellido1(String resiApellido1) {
		this.resiApellido1 = resiApellido1;
	}




	public String getResiApellido2() {
		return resiApellido2;
	}




	public void setResiApellido2(String resiApellido2) {
		this.resiApellido2 = resiApellido2;
	}




	public List getResiTomas() {
		return resiTomas;
	}
	...
	public void setResiTomas(List resiTomas) {
		this.resiTomas = resiTomas;
	}
	...
	public String getDiasSemanaConcretos() {
		return diasSemanaConcretos;
	}




	public void setDiasSemanaConcretos(String diasSemanaConcretos) {
		this.diasSemanaConcretos = diasSemanaConcretos;
	}
