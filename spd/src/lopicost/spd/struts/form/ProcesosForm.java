...
public class ProcesosForm extends GenericForm {
    ...
    private int maxDuracionSegundos=120; 		// Máxima duración de la ejecutó en segundos
    private String fechaDesde;               	// Fecha de activación del proceso
    private String fechaHasta;                  // Fecha de desactivación del proceso
    private String fechaInicioEjecucion;        // Fecha de inicio de la ejecutó (si está en ejecutó)
    private String fechaFinEjecucion;           // Fecha de fin de la ejecutó (si está finalizado)
    private int duracionSegundos=0; 			// Duración de la última ejecutó en segundos
    private String resultado;                   // Resultado de la ejecutó
    private String usuarioEjecucion;        	// Usuario que ejecutó el proceso 
    private String mensaje;                     // Mensaje adicional de la ejecutó
    ...
    private String error;                       // Error ocurrido durante la ejecutó
