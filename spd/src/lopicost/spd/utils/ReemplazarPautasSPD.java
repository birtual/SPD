...
public class ReemplazarPautasSPD{
	...
	public final static String makeFlat(String q){
		q = ReemplazarPautasSPD.replaceChar(q,'Á','A');
		q = ReemplazarPautasSPD.replaceChar(q,'É','E');
		q = ReemplazarPautasSPD.replaceChar(q,'Í','I');
		q = ReemplazarPautasSPD.replaceChar(q,'Ó','O');
		q = ReemplazarPautasSPD.replaceChar(q,'Ú','U');
		q = ReemplazarPautasSPD.replaceChar(q,'À','A');
		q = ReemplazarPautasSPD.replaceChar(q,'È','E');
		q = ReemplazarPautasSPD.replaceChar(q,'Ì','I');
		q = ReemplazarPautasSPD.replaceChar(q,'Ò','O');
		q = ReemplazarPautasSPD.replaceChar(q,'Ù','U');
		q = ReemplazarPautasSPD.replaceChar(q,'Ä','A');
		q = ReemplazarPautasSPD.replaceChar(q,'Ë','E');
		q = ReemplazarPautasSPD.replaceChar(q,'Ï','I');
		q = ReemplazarPautasSPD.replaceChar(q,'Ö','O');
		q = ReemplazarPautasSPD.replaceChar(q,'Ü','U');
		q = ReemplazarPautasSPD.replaceChar(q,'Ñ','N');
		q = ReemplazarPautasSPD.replaceChar(q,'Ç','C');
