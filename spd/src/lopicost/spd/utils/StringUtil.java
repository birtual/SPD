...
*/
	...
	public static String getStringArregloFecha(String fechaString, String formato) {
		...
		try{
			...
			//devolvemos fecha en caso que dia y mes están dentro del rango. sino devolvemos ""
	...
	public static String getStringArregloFechaBak(String fechaString) {
		try{
			...
			int anyo=Integer.parseInt(fechaString.substring(6));
			  ...
			  //devolvemos fecha en caso que dia y mes están dentro del rango. Es posible que se reciba 31/04/, en este caso se transformaría en 01/05
